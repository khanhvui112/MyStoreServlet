    ...
    <body style="background: unset;" class="nav-md">
                            ...
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    <c:if test="${loginDTO.getRole().equalsIgnoreCase('admin')}">
                                        <li><a id="home"><i class="fa fa-user"></i> Quản lí hệ thống<span
                                                class="fa fa-chevron-down"></span></a>
                                            <ul class="menu employee text-white" style="display:none;" id="employee">
                                                <li id="all-employee"><a >Nhân viên</a></li>
                                                <li><a href="index2.html">Menu</a></li>
                                                <li><a href="index3.html">Sản phẩm</a></li>
                                            </ul>
                                        </li>
                                    </c:if>
                                    <li><a id="product"><i class="fa fa-product-hunt"></i> Quản lí sản phẩm <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="menu products-hidden">
                                            <li><a href="form.html">Xem tất danh sách sản phẩm</a></li>
                                            <li><a href="form_advanced.html">Thêm sản phẩm</a></li>
                                            <li><a href="form_validation.html">Sửa sản phẩm</a></li>
                                            <li><a href="form_wizards.html">Xóa sản phẩm</a></li>
                                        </ul>
                                    </li>
                            ...
                            <ul class=" navbar-right">
                                <li class="nav-item dropdown open" style="padding-left: 15px;">
                                    ...
                                    <div class="dropdown-menu dropdown-usermenu pull-right"
                                        ...
                                        <a class="dropdown-item" href="javascript:;"> Thông tin tài khoản</a>
                                        <a class="dropdown-item" href="javascript:;">Cài đặt</a>
                                        <a class="dropdown-item" href="javascript:;">Hỗ trợ</a>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending">Tên
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending">Tên tài khoản
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Age: activate to sort column ascending">Email
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Start date: activate to sort column ascending">Số điện thoại
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending">Ngày sinh
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending">Giới tính
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending">Địa chỉ
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending">Phòng ban
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending">Quyền
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <footer>
            <div class="pull-right">
                Admin Template by <a href="https://colorlib.com">Sần Vui</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
